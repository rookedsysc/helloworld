...
class ProductManageController(
    ...
    fun list(
        ...
        val productResponses: Page<ProductListResponse> = productResults.map { productResult ->
            ProductListResponse.of(productResult)
        }
    ...
    fun get(@PathVariable productId: Long): ProductListResponse {
        val productResult = productListService.get(productId)
        return ProductListResponse.of(productResult)
    }
